...
with (open(output, mode = 'w'))as outfile:
    ...
    for sample in infoSort:
        ...
        outfile.write ("RAWDATA_PE1_ARR_[${COUNT}]=\"$RAW_PATH/" + sample + "_" + info[sample]['barcode'] + "_L002_R1_001.fastq.gz" + "\";\n")
        outfile.write ("RAWDATA_PE2_ARR_[${COUNT}]=\"$RAW_PATH/" + sample + "_" + info[sample]['barcode'] + "_L002_R2_001.fastq.gz" + "\";\n")
