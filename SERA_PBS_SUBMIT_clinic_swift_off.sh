...
2 "Remove adapter sequences from reads" off "Run_cutAdapt_swift_all.sh" false 0 \
...
20 "Run Pindel" off "Run_Pindel.sh" "6" 0 \
...
100 "Copy results to OUTBOX" off "Move_results2outbox.sh" "13:21:25:26:31:33:35:40" 2 \
101 "Copy results to storage" off "Move_results2storage.sh" "13:21:25:26:31:33:35:40" 2);
